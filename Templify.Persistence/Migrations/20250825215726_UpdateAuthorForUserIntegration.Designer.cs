...
namespace Templify.Persistence.Migrations
{
    ...
    [Migration("20250825215726_UpdateAuthorForUserIntegration")]
    partial class UpdateAuthorForUserIntegration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Templify.Domain.Entities.AuthorSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Templify.Domain.Entities.ProductPurchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Templify.Domain.Entities.Author", b =>
                {
                    b.HasOne("Templify.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("Templify.Domain.Entities.AuthorSubscription", b =>
                {
                    ...
                    b.HasOne("Templify.Domain.Entities.Author", "Author")
